...
<!-- untuk menampilkan dibagian dibagian header  -->
...
<head>
    ...
    <title><?= $title; ?> | Aplikasi Pendataan SMA N 1 Dompu</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">DATA SMA 1 Dompu</div>
            </a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Pendataan SMA 1 Dompu 2020 &bull; by <?= anchor('http://sekolah.data.kemdikbud.go.id/', 'SMAN1Dompu.id'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
